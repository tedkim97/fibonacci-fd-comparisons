...
namespace FibDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"FD({N}) <BigInteger> (ticks)");
            ...
            Console.WriteLine($"FD Iteration({N}) <BigInteger> (ticks)");
            ...
            Console.WriteLine($"FD Tail Recursion({N}) <BigInteger> (ticks)");
